      ...
      <div className='flex flex-wrap justify-center items-center gap-24 px-6 pb-12'>
        ...
        <form className='flex'>
          <div className='flex focus-within:border-sky300 focus-within:ring-opacity-40 p-1 border rounded-lg focus-within:ring focus-within:ring-sky300 overflow-hidden'>
            ...
            <button
              type='submit'
              className='bg-pink700 hover:bg-sky300 px-4 py-2 rounded-r-lg font-medium text-sm text-white uppercase tracking-wider transform transition-colors duration-300 focus:outline-none'
            >
              Search
            </button>
          </div>
      ...
      <div className='w-full'>
        ...
        <div className='flex justify-center mt-12'>
          <button
            ...
            className='bg-purple800 disabled:hover:bg-gray-200 hover:bg-sky300 mx-1 px-4 py-2 rounded-md text-white hover:text-white disabled:text-gray-500 capitalize disabled:cursor-not-allowed'
          >
            Previous
          </button>
          ...
          <button
            ...
            onClick={() => handlePaginationButton(currentpage + 1)}
            className='bg-purple800 hover:bg-sky300 mx-1 px-4 py-2 rounded-md text-white hover:text-white disabled:text-gray-500 disabled:cursor-not-allowed'
          >
            Next
          </button>
        </div>
