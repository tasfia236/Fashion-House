  ...
  return (
    <div className='relative flex flex-col flex-grow bg-center shadow-lg rounded-lg w-80 h-full transform transition-transform duration-300 overflow-hidden'>
      ...
      <div className='relative z-50 flex flex-col flex-grow p-4 sm:p-6 text-white'>
        <div className='top-2 right-2 absolute flex-grow bg-pink700 bg-yellow-400 m-2 px-6 p-2 rounded-full font-bold text-white text-xs'>
        ...
        <div className='p-5'>
          ...
          <div className='flex justify-between mt-6'>
            <Link to={`dashboard/updateproduct/${product._id}`}>
              <button className='border-2 border-white bg-transparent hover:bg-pink700 shadow-lg px-4 py-2 rounded-md font-semibold text-sm text-white transition duration-200'>
                Update
              </button>
            </Link>
            <button
              onClick={() => handleDeleteProduct(product)}
              className='border-2 border-white bg-pink700 hover:bg-transparent px-4 py-2 rounded-md font-semibold text-sm text-white transition duration-200 outline-none'
            >
              Delete
            </button>
          </div>
